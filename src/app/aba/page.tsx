  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn about Behavior Analysis and its applications in clinical, educational, and organizational settings." />
      </Head>
      ...
      <div className={styles.container}>
        ...
        <section className={styles.applicationSection}>
          <h2>Applications of Behavior Analysis</h2>
          
          <div className={styles.applicationBlock}>
            <Image src="/clinical-behavior-analysis.jpg" alt="Clinical Behavior Analysis" width={500} height={300} loading="lazy" />
          ...
          <div className={styles.applicationBlock}>
            <Image src="/educational-initiatives.jpg" alt="Educational Initiatives" width={500} height={300} loading="lazy" />
          ...
          <div className={styles.applicationBlock}>
            <Image src="/organizational-behavior.jpg" alt="Organizational Behavior Management" width={500} height={300} loading="lazy" />
          ...
          <div className={styles.applicationBlock}>
            <Image src="/sports-performance.jpg" alt="Sports Performance" width={500} height={300} loading="lazy" />
